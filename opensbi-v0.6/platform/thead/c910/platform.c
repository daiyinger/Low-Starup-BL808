...
static u32 c910_pmp_region_count(u32 hartid)
{
	return 5;
}
 ...
 * a given HART.
 */
static int c910_pmp_region_info(u32 hartid, u32 index, ulong *prot,
				 ulong *addr, ulong *log2size)
{
	...
	case 0:
		...
		*log2size = log2roundup(0x20000000);
		break;
	case 1:
		*prot	  =  PMP_A | PMP_R | PMP_W | PMP_X;
		*addr	  = 0x40000000;
		*log2size = log2roundup(1 << 14);
		break;
	case 2:
		*prot	  = PMP_A | PMP_R | PMP_W | PMP_X;
		*addr	  = 0x50000000;
		*log2size = log2roundup(0x4000000);
		break;		
	case 3:
		*prot	  = PMP_A | PMP_R | PMP_W;
		*addr	  = 0x58000000;
...
const struct sbi_platform_operations platform_ops = {
	...
	.pmp_region_count    = c910_pmp_region_count,
	.pmp_region_info     = c910_pmp_region_info,
...
const struct sbi_platform platform = {
	...
	.name                = "Bouffalo_Lab BL808  T-HEAD Xuantie c906",
